package misc; /* Copyright (c) Project Nayuki
 *
...
public final class Ripemd160 {
    ...
    private static final int[] RL = {  // bitcoffee.Message schedule for left line
    ...
    private static final int[] RR = {  // bitcoffee.Message schedule for right line
